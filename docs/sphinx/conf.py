...
project = project = 'Observing Simulation for SDSS-V'
copyright = '{0}, {1}'.format('2017', 'Michael Blanton')
...
html_theme_options = {
    'logo': 'sdss_logo.png',
    'github_user': 'blanton144',
    'github_repo': 'observesim',
    'github_button': True,
    'github_type': 'star',
...
htmlhelp_basename = '{0}pdoc'.format('observesim')
...
man_pages = [
    (master_doc, 'observesim', u'{0} Documentation'.format(project),
     [author], 1)
]
