...
-- Indices
CREATE INDEX CONCURRENTLY ra ON catalogdb.gaia_dr1_source using BTREE(file_pk);
CREATE INDEX CONCURRENTLY dec ON catalogdb.gaia_dr1_source using BTREE(file_pk);
CREATE INDEX CONCURRENTLY l ON catalogdb.gaia_dr1_source using BTREE(file_pk);
CREATE INDEX CONCURRENTLY b ON catalogdb.gaia_dr1_source using BTREE(file_pk);
CREATE INDEX CONCURRENTLY ecl_lon ON catalogdb.gaia_dr1_source using BTREE(file_pk);
CREATE INDEX CONCURRENTLY ecl_lat ON catalogdb.gaia_dr1_source using BTREE(file_pk);
CREATE INDEX CONCURRENTLY phot_g_mean_flux ON catalogdb.gaia_dr1_source using BTREE(file_pk);
CREATE INDEX CONCURRENTLY phot_g_mean_mag ON catalogdb.gaia_dr1_source using BTREE(file_pk);
CREATE INDEX CONCURRENTLY solution_id ON catalogdb.gaia_dr1_source using BTREE(file_pk);
CREATE INDEX CONCURRENTLY source_id ON catalogdb.gaia_dr1_source using BTREE(file_pk);

CREATE INDEX CONCURRENTLY ra ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY dec ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY l ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY b ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY ecl_lon ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY ecl_lat ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY phot_g_mean_flux ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY phot_g_mean_mag ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY solution_id ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY source_id ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY hip ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY tycho2_id ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
CREATE INDEX CONCURRENTLY duplicated_source ON catalogdb.gaia_dr1_tgas using BTREE(file_pk);
